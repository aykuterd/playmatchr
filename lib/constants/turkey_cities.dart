...
/// Kaynak: GitHub - turkey-cities-districts
/// 81 İl ve tüm ilçeler
...
class TurkeyCities {
  static const Map<String, List<String>> cities = {
    ...
    'Muğla': ['Bodrum', 'Dalaman', 'Datça', 'Fethiye', 'Kavaklıdere', 'Köyceğiz', 'Marma​ris', 'Menteşe', 'Milas', 'Ortaca', 'Seydikemer', 'Ula', 'Yatağan'],
  ...
  /// Tüm illerin alfabetik listesi
  static List<String> get cityNames => cities.keys.toList()..sort();
  ...
  /// Toplam il sayısı
  static int get totalCities => cities.length;

  /// Toplam ilçe sayısı
  static int get totalDistricts =>
      cities.values.fold(0, (sum, districts) => sum + districts.length);
}
